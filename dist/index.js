...
var _args = [
	[
		"axios@0.20.0",
		"/Users/kirschner/projects/react-cmi5-context"
	]
];
...
var _spec = "0.20.0";
var _where = "/Users/kirschner/projects/react-cmi5-context";
var author = {
	name: "Matt Zabriskie"
};
var browser$1 = {
...
var InvalidXapiFormatError = /** @class */ (function (_super) {
    ...
    function InvalidXapiFormatError(message, status) {
        if (message === void 0) { message = "invalid xapi format"; }
...
var XapiWrongUser = /** @class */ (function (_super) {
    ...
    function XapiWrongUser(message, status) {
        if (message === void 0) { message = "attempt to save a record for a user different from the authorized user"; }
...
var TinCanLRS = /** @class */ (function () {
    ...
    TinCanLRS.prototype.saveStatements = function (statements) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            try {
                tcStatements = statements.map(function (s) { return new TinCan.Statement(s); });
            }
            catch (err) {
            ...
            _this._lrs.saveStatements(tcStatements, {
                callback: function (err, xhr) {
                    ...
                    var ids = typeof xhr.response === "string"
...
var _CmiService = /** @class */ (function () {
    ...
    _CmiService.prototype.prepareActivityStatement = function (p) {
        return {
            ...
            context: __assign(__assign({}, p.context), { registration: this.params.registration }),
            object: {
    ...
    _CmiService.prototype.sendActivityStatement = function (p) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                (_a = this._lrs) === null || _a === void 0 ? void 0 : _a.saveStatements([statement]);
                this.updateState(__assign(__assign({}, this._state), { statements: __spreadArrays(this.state.statements, [statement]) }));
                return [2 /*return*/];
            });
        });
    };
    _CmiService.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.state.statements.find(function (s) { return s.verb.id === VERB_INITIALIZED; })) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.sendActivityStatement({ verb: VERB_INITIALIZED })];
                    case 3:
                        _a.sent();
                        this.updateState(__assign(__assign({}, this._state), { start: new Date() }));
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.state.statements.find(function (s) { return s.verb.id === VERB_PASSED; })) {
                            throw new Error("only one passed statement is allowed per registration");
                        }
                        lms = this.state.lmsLaunchData.contents || {};
                        return [4 /*yield*/, this.sendActivityStatement({
                                verb: VERB_PASSED,
                                context: {
                                    contextActivities: {
                                        category: [Cmi5ContextActivity.MOVE_ON],
                                    },
                                    extensions: __assign(__assign({}, p.contextExtensions), (lms.masteryScore
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (this.state.statements.find(function (s) { return s.verb.id === VERB_COMPLETED; })) {
                            throw new Error("only one completed statement is allowed per registration");
                        }
                        s = this.state.statements.find(function (s) { return s.verb.id === VERB_PASSED || s.verb.id === VERB_FAILED; });
                        return [4 /*yield*/, this.sendActivityStatement(__assign(__assign({}, extensions), { verb: VERB_COMPLETED, context: {
                                    contextActivities: {
                                        category: [Cmi5ContextActivity.MOVE_ON],
                                    },
                                    ...
                                    duration: getISODuration(this.state.start),
                                    score: s ? (_a = s.result) === null || _a === void 0 ? void 0 : _a.score : undefined,
                                    completion: true,
                                } }))];
                    case 1:
                        _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _a = moveOn;
                        switch (_a) {
                            case "Passed": return [3 /*break*/, 3];
                            case "Completed": return [3 /*break*/, 5];
                            case "CompletedAndPassed": return [3 /*break*/, 7];
                            case "CompletedOrPassed": return [3 /*break*/, 10];
                        }
                        return [3 /*break*/, 15];
                    case 3:
                        if (!passed) {
                    ...
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 17];
                    case 5: return [4 /*yield*/, this.completed(p.contextExtensions)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 17];
                    case 7:
                    ...
                    case 11:
                        _b.sent();
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, this.completed(p.contextExtensions)];
                    case 13:
                        _b.sent();
                        _b.label = 14;
                    case 14: return [3 /*break*/, 17];
                    case 15: return [4 /*yield*/, this.completed(p.contextExtensions)];
                    case 16:
                        _b.sent();
                        _b.label = 17;
                    case 17: return [4 /*yield*/, this.terminate()];
                    case 18:
                        _b.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.state.statements.find(function (s) { return s.verb.id === VERB_TERMINATED; })) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.sendActivityStatement({
    ...
    _CmiService.prototype._authenticate = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.updateState(__assign(__assign({}, this._state), { authStatus: AUTH_STATUS_IN_PROGRESS }));
                        return [4 /*yield*/, axios$1.post(this.params.fetch)];
                    case 1:
                        res = _b.sent();
                        accessToken = res.data["auth-token"];
                        if (!accessToken) {
                            this.updateState(__assign(__assign({}, this._state), { authStatus: AUTH_STATUS_FAILED }));
                            throw new Error("invalid response from fetch " + this.params.fetch + ": " + res.data);
                        }
                        ...
                        this.updateState(__assign(__assign({}, this._state), { authStatus: AUTH_STATUS_SUCCESS, accessToken: accessToken }));
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.updateState(__assign(__assign({}, this._state), { activityStatus: ACTIVITY_STATUS_IN_PROGRESS }));
                        return [4 /*yield*/, ((_a = this._lrs) === null || _a === void 0 ? void 0 : _a.fetchActivityState({
                    ...
                    case 1:
                        res = _b.sent();
                        if (!res) {
                            this.updateState(__assign(__assign({}, this._state), { activityStatus: ACTIVITY_STATUS_FAILED }));
                            throw new Error("invalid response from load LMS launch data: " + res);
                        }
                        this.updateState(__assign(__assign({}, this._state), { activityStatus: ACTIVITY_STATUS_SUCCESS, lmsLaunchData: res }));
                        return [2 /*return*/];
                }
            });
        });
