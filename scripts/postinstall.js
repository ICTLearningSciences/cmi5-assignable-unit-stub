...
const installCmi5Lib = async() => {
	...
	try {
		if(!await fs.exists(libPath)) {
			console.warn(`react-cmi5 should install client lib 'cmi5.js' to public in the react project where it is installed, but library not found at ${libPath}`)
		...
		console.log(`react-cmi5 will attempt to install client lib from ${libPath} to ${tgtPath}...`)
